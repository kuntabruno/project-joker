...
export default function CategoriesCardsGrid({ categories }: { categories: ICategoryButtonProps[] }) {

   if (!categories || !categories.length) {
      return <span className="text-center font-bold text text-3xl my-8">No Categories to Show</span>
   }
   return (
